 ...
 * <li>doi.sharedSecret></li>
 * </ul>
 * 
 * @author Rahul Khanna
 * 
 */
public class DoiConfigFile implements DoiConfig {
	private static final Logger LOGGER = LoggerFactory.getLogger(DoiConfigFile.class);
	 ...
	 */
	public DoiConfigFile(Properties props) {
		this.props = props;
	}
	
	public DoiConfigFile(File configFile) throws IOException {
		this(new FileInputStream(configFile));
	}
	
	public DoiConfigFile(InputStream configStream) throws IOException {
